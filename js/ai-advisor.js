...
class AIAdvisorManager {
  ...
  generateSmartRuleResponse(query, stats, classes) {
    ...
    if (q.includes('เกรด') || q.includes('gpa') || q.includes('เกียรตินิยม') || q.includes('f')) {
      if (!stats.earnedCredits || stats.earnedCredits === 0) {
        return `พี่ยังไม่ได้เริ่มเพิ่มรายวิชาในแท็บ **"คำนวณเกรด"** เลยค่ะ 🌸\n\nลองกดปุ่ม **"+ เพิ่มชั้นปีใหม่"** หรือ **"+ เพิ่มเทอมใหม่"** แล้วใส่เกรดวิชาที่เรียนดูนะคะ น้องกุลสตรีจะช่วยคำนวณ GPAX และวิเคราะห์แนวทางคว้าเกียรตินิยมให้แบบเรียลไทม์เลยค่ะ! 🎓✨`;
      }
    ...
    if (q.includes('ตาราง') || q.includes('วิชา') || q.includes('เรียน') || q.includes('เวลา')) {
      if (!classes || classes.length === 0) {
        return `ตอนนี้ยังไม่มีวิชาเรียนในตารางเลยค่ะ 🌸\n\nพี่สามารถกดปุ่ม **"+ เพิ่มวิชาเรียน"** สีชมพูด้านบนเพื่อเริ่มจัดตารางเรียนของเทอมนี้ได้เลยนะคะ พอจัดเสร็จแล้วสามารถดาวน์โหลดเป็น **Wallpaper มือถือ (9:16)** น่ารักๆ ไปตั้งหน้าจอได้ทันทีเลยค่ะ 📲🎀`;
      }
